...
INSERT into seminar(SEM_STREET, SEM_HOUSE_NUMBER, SEM_PLZ, SEM_LOCATION, SEM_TITLE, SEM_DATE, SEM_CATEGORY, SEM_URL,
                    SEM_DESCRIPTION)
      values ('Wankdorffeldstrasse','102',3014,'Bern', 'Wie unterstütze ich einen Angehörigen?', parsedatetime('2019-11-07 13:30:00.0', 'yyyy-MM-dd hh:mm:ss.SS'), 3,
...
INSERT into seminar(SEM_STREET, SEM_HOUSE_NUMBER, SEM_PLZ, SEM_LOCATION, SEM_TITLE, SEM_DATE, SEM_CATEGORY, SEM_URL,
                    SEM_DESCRIPTION)
      values ('Schanzenstrasse','5',3008,'Bern', 'Sozialphobie - Mit der Angst umgehen', parsedatetime('2019-08-07 10:30:00.0', 'yyyy-MM-dd hh:mm:ss.SS'), 1,
...
INSERT into seminar(SEM_STREET, SEM_HOUSE_NUMBER, SEM_PLZ, SEM_LOCATION, SEM_TITLE, SEM_DATE, SEM_CATEGORY, SEM_URL,
                    SEM_DESCRIPTION)
      values ('Bachweg','18b',3852,'Rothrist', 'Angehörigentreffen', parsedatetime('2019-09-09 20:00:00.0', 'yyyy-MM-dd hh:mm:ss.SS'), 2,
...
INSERT into seminar(SEM_STREET, SEM_HOUSE_NUMBER, SEM_PLZ, SEM_LOCATION, SEM_TITLE, SEM_DATE, SEM_CATEGORY, SEM_URL,
                    SEM_DESCRIPTION)
      values ('Badenerstrasse','420',8040,'Zürich', 'Betroffenenhöck', parsedatetime('2020-02-15 09:00:00.0', 'yyyy-MM-dd hh:mm:ss.SS'), 1,
